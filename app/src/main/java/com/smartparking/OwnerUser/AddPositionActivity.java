package com.smartparking.OwnerUser;
...
import com.smartparking.classes.SlotNoInfo;
        ...
        addLocationBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(globalLatLng==null){
                    ...
                    Toast.makeText(AddPositionActivity.this, "Invalid Email ID!", Toast.LENGTH_SHORT).show();
                                ...
                                db.getReference("UpiInfo")
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            Toast.makeText(AddPositionActivity.this, "Failed to add OwnerInfo details", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                            } else {
