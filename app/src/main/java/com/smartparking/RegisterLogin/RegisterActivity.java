    ...
    private void attachListeners() {
        registerBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                String txt_contact_no=contactNo.getText().toString().trim();
                String txt_country_code=ccp.getSelectedCountryCode();
                Log.d("Country Code",txt_country_code);
                ...
                if(!utils.isNameValid(txt_name)){
                    ...
                    progressDialog.show();
                    Log.e("Phone : ",txt_country_code+txt_contact_no);
                    registerUser(txt_email, txt_password, txt_name, txt_country_code+txt_contact_no, userType);
                }else{
                    Toast.makeText(RegisterActivity.this, "No Network Available!", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        ccp.setOnCountryChangeListener(new CountryCodePicker.OnCountryChangeListener() {
            ...
            public void onCountrySelected() {
                Log.d("Country Code",ccp.getSelectedCountryCode());
            }
        });
