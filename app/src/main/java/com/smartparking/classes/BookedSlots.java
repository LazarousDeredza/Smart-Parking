...
public class BookedSlots implements Serializable {
    ...
    public int hasPaid,amount,wheelerType,notificationID,readNotification,
            readBookedNotification,checkout;
    public Date startTime, endTime, checkoutTime;

    public BookedSlots(){}

    public BookedSlots(String userID, String placeID, String slotNo,
                       String numberPlate, int wheelerType, Date startTime,
                       Date endTime, int hasPaid, int amount,int notificationID,
                       int readNotification,int readBookedNotification){
        this.userID=userID;
